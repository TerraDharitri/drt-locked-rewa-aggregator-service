...
import { DEADRARE_KEY, NUMBATNFTSWAP_KEY, FRAMEIT_KEY, ICI_KEY, XOXNO_KEY } from 'src/utils/constants';
...
export class Marketplace {
  ...
  private static getMarketplaceUrl(
    ...
    if (identifier) {
      switch (entity.key) {
        case XOXNO_KEY:
          return marketplaceAuctionId && nftType === NftTypeEnum.SemiFungibleDCDT
  ...
  static fromEntityForNumbatSwap(entity: MarketplaceEntity, collection: string, marketplaceAuctionId: number, nonce: number) {
