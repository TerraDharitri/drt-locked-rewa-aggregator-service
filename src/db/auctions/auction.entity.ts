...
export class AuctionEntity extends BaseEntity {
  ...
  static fromWithdrawTopics(
    ...
    return new AuctionEntity({
      ...
      status: AuctionStatusEnum.Running,
      type:
        topicsAuctionToken.auctionType === '' || parseInt(topicsAuctionToken.auctionType) === NumbatSwapAuctionTypeEnum.Auction
          ? AuctionTypeEnum.Nft
      ...
      maxBid:
        parseInt(topicsAuctionToken.auctionType) === NumbatSwapAuctionTypeEnum.Buy || marketplaceKey === ENEFTOR_KEY
