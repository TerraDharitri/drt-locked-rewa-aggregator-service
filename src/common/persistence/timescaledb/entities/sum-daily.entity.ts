...
@ViewEntity({
  expression: `
    SELECT
      ...
      SUM(CASE WHEN "marketplaceKey" ='numbatapes' THEN value ELSE 0 END) as numbatapes,
      ...
      SUM(CASE WHEN "marketplaceKey" ='numbatnftswap' THEN value ELSE 0 END) as numbatnftswap,
